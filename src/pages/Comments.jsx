        ...
        <div className="bg-white-gradient lg:h-[100vh]" >
            ...
            <div className="flex flex-col w-[90%] lg:w-[80%] lg:h-auto h-[50%] justify-around m-auto gap-2 py-4">
                ...
                <div className="flex flex-col lg:flex-row gap-5">
                    <div className="flex flex-col items-center content-center bg-[color:var(--col-purer-white)] rounded-[22px] py-5 gap-3 drop-shadow-xl overflow-auto h-[30em] lg:w-[60%]">                
